> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/onlain-zapis/onlain-zapis-dlya-uslug/chat-bot-dlya-onlain-zapisi.md).
...
{% hint style="info" %}
Чтобы увидеть детальную схему настройки чат-бота для онлайн записи с использованными функциями, ознакомьтесь с параграфом "[Пример реализации бота](#primer-realizacii-bota)" данной статьи.&#x20;
{% endhint %}
...
<figure><img src="/files/d6lUyniTVL0MrTcyiFeY" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/drRrdEKrr3bCWCJhNjtD" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/onlain-zapis/onlain-zapis-dlya-uslug/chat-bot-dlya-onlain-zapisi.md?ask=<question>
```
