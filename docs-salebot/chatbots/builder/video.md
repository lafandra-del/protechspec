> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/builder/video.md).
...
{% hint style="info" %}
Как работать с мессенджером Telegram, рассказали в [одноименном разделе](/chatbots/channels/telegram.md)
{% endhint %}
...
```
GET https://docs.salebot.pro/chatbots/builder/video.md?ask=<question>
```
