> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/peremennye-i-funkcii/kalkulyator/dlya-raboty-s-datami-i-vremenem.md).
...
* [прибавить ко времени время](#kak-pribavit-ko-vremeni-vremya)
* [сравнить время](#kak-sravnit-vremya)
* [задать временные интервалы](#kak-zadat-vremennye-intervaly)
* [узнать сколько времени до дня D](#kak-uznat-skolko-vremeni-ostalos-do-dnya-d)
* [узнать ближайший день рождения](#kak-uznat-blizhaishii-den-rozhdeniya)
* [получить дату дня недели](#kak-poluchit-datu-dnya-nedeli)
* [получить дату дня месяца](#kak-poluchit-datu-dnya-mesyaca)
* [проверить попадание в рабочее время](#kak-proverit-popadaniya-v-rabochee-vremya-ili-v-nerabochee)
* [конвертировать дату и время](#kak-konvertirovat-datu-i-vremya)
* [видеоурок](#videourok)
...
**addDays(дата, дней\_прибавить) -** для прибавления к дате указанного количества дней. Для вычитания передайте отрицательное число. Пример: *addDays(current\_date, 20)* или *addDays('20.08.2019', -99)*&#x20;

**addMinutes(время, минут\_прибавить)** прибавляет к указанному времени количество минут. Для вычитания передайте отрицательное число. Пример: *addMinutes(current\_time, 20)* или *addMinutes('20:08', -30)*
...
<figure><img src="/files/a95Pac1BHspEYA51DKVm" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/IsabdeGdqVDPKmAhFWmQ" alt=""><figcaption></figcaption></figure>

Пример - прибавим к дате некое количество месяцев:

<figure><img src="/files/BHjZQxDdgKABASYq1pcW" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/eFj0Ik3lKp8lagco1gFH" alt=""><figcaption></figcaption></figure>

Пример использования простого математического действия - сложения даты и дней, времени и минут:

<figure><img src="/files/Srektugt2LLXYGtO1qY5" alt="" width="351"><figcaption></figcaption></figure>

![](/files/s7irrXoICudunoW4WNbA)
{% endtab %}
...
<figure><img src="/files/52pxZS5dp5RZOPgV8RRG" alt=""><figcaption><p>подраздел Условия в блоках с условиями и стрелках</p></figcaption></figure>

При указании условий сравнения в стрелке обязательно используйте задержки

<figure><img src="/files/0clvMV98E5S2lAvS6Q0O" alt=""><figcaption></figcaption></figure>
{% endtab %}
...
<figure><img src="/files/QePxZ6hqknaZXXKtAmBe" alt="" width="514"><figcaption><p>Настройка блока на типовой автоответчик</p></figcaption></figure>

<figure><img src="/files/qcVF3iDZt4uzTZqikhI2" alt=""><figcaption><p>Тестируем функцию timeinterval()</p></figcaption></figure>
{% endtab %}
...
<figure><img src="/files/cJ0lYhjhgmoubjo0s6AQ" alt="" width="524"><figcaption></figcaption></figure>
...
Принимает **два параметра**.\ <mark style="color:$success;">**weekday — день недели**</mark>, дату которого необходимо определить (от 1 до 7).\ <mark style="color:$success;">**b — параметр,**</mark> который показывает, **возвращать ли сегодняшнюю дату, если нужный день сегодня**. Второй параметр можно не указывать, по умолчанию False. Его значение давайте рассмотрим на примере:&#x20;
...
<figure><img src="/files/8GAaVYWUfDchGmGF5BE0" alt=""><figcaption><p>Пример использования функции в поле Дата отправки в стрелке(соединение блоков)</p></figcaption></figure>
...
<figure><img src="/files/nhi0FXtP7yD9Nm2Cy55O" alt=""><figcaption></figcaption></figure>
...
Чтобы вывести дату в виде "dd название месяца", воспользуйтесь функцией current\_*date\_rus(). Она выведет сегодняшнюю дату в виде числа и названия месяца в родительном падеже, например, 3 апреля.*
...
*current\_date\_rus() - 3 апреля*\
*current\_date\_rus(2) - 5 апреля*\
*current\_date\_rus(-2) - 1 апреля*
...
```
GET https://docs.salebot.pro/chatbots/peremennye-i-funkcii/kalkulyator/dlya-raboty-s-datami-i-vremenem.md?ask=<question>
```
