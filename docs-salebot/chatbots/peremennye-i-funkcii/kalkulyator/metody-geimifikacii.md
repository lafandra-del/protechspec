> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/peremennye-i-funkcii/kalkulyator/metody-geimifikacii.md).
...
```
GET https://docs.salebot.pro/chatbots/peremennye-i-funkcii/kalkulyator/metody-geimifikacii.md?ask=<question>
```
