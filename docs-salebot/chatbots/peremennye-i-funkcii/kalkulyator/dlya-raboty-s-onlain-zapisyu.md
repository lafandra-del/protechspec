> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/peremennye-i-funkcii/kalkulyator/dlya-raboty-s-onlain-zapisyu.md).
...
<figure><img src="/files/ow4WzFPLhDcE5yao1v9R" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/OdHgMpDP2jDwLZxkat2g" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/RPMtWzpHuBgrCrcpKVOV" alt=""><figcaption><p>Рис. Первый блок</p></figcaption></figure>
...
<figure><img src="/files/B5zdoZCLYlSLlURM0TQT" alt="" width="375"><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/chatbots/peremennye-i-funkcii/kalkulyator/dlya-raboty-s-onlain-zapisyu.md?ask=<question>
```
