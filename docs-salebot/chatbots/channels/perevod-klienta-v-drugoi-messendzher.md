> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/channels/perevod-klienta-v-drugoi-messendzher.md).
...
<figure><img src="/files/zK7YwqrumiVyfCJy69ze" alt=""><figcaption><p>Связанные клиенты отобразятся в карточке клиента. </p></figcaption></figure>
...
<figure><img src="/files/Z3MRZvmwYHQnSPhNPDoj" alt=""><figcaption><p>Свяжет текущего клиента с главным клиентом. </p></figcaption></figure>
...
\
\&#xNAN;*Функция может работать, как без параметра так и с ним.* \
\
...
<figure><img src="/files/LuDh5LGiPJaQTrkJmol5" alt=""><figcaption><p>Удаление связи между клиентами.</p></figcaption></figure>
...
<figure><img src="/files/XbWt2NpgxzQcUQZSCDal" alt=""><figcaption></figcaption></figure>

В диалоге Whatsapp ссылка выглядит следующим образом:

<figure><img src="/files/1F2CgmTyTRxVXC8JS2EX" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/bP6eTTmnEHG0E1gTjpWo" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/ABPaWVb3SkiEE4Nvcy6V" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/chatbots/channels/perevod-klienta-v-drugoi-messendzher.md?ask=<question>
```
