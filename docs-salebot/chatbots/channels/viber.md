> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/channels/viber.md).
...
<figure><img src="/files/UjDBPQfRWRSgv2lcn239" alt=""><figcaption></figcaption></figure>

Далее нужно создать паблик аккаунт для нашего бота. Выбираем фото и заполняем все поля:

<figure><img src="/files/HI4e4ujtU0ZXm6ursHVR" alt=""><figcaption></figcaption></figure>
...
{% hint style="warning" %}
&#x20;В форме регистрации есть переключатель "The account contains adult content". \ <mark style="color:red;">**НЕ ВКЛЮЧАЙТЕ!**</mark> \
Иначе перед запуском бота у всех пользователей будет предупреждение, что бот содержит контент для взрослых.
{% endhint %}

<figure><img src="/files/0E6Jlr0eEaSI86WqcoBp" alt=""><figcaption></figcaption></figure>

Нужно принять условия лицензионного соглашения и нажать "Create".&#x20;

<figure><img src="/files/LLsx55AEEaBEwleX1Uya" alt=""><figcaption></figcaption></figure>

Если все заполнено верно, вы получите токен бота, он будет нужен для следующего шага:

&#x20;

<figure><img src="/files/y4BOpqJiD7chO00jyPP8" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/pwEzuHUVjIa7gGevvnoa" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="/files/awS30RtdLWgSVNsqTGA1" alt=""><figcaption><p>Рис. 1 Оригинальная форма заявки</p></figcaption></figure> <figure><img src="/files/p8T134ELMJpYT8QPNbDE" alt=""><figcaption><p>Рис. 2 Переведенная форма заявки</p></figcaption></figure></div>
...
<figure><img src="/files/yq9kelgX6m5lGesu1GNl" alt=""><figcaption><p>Подключенный бот Viber</p></figcaption></figure>
...
![пример Карусели в Viber](/files/yuMbtFtZYpSgpxHDNHFa)
...
![Пример использования url в карточке карусели](/files/D7843B13Qoqxxd4rJqKC)
...
<figure><img src="/files/Jymtv0u0E9icO7nPQBP2" alt=""><figcaption><p>Пример использования payload</p></figcaption></figure>
...
<figure><img src="/files/f26XCooflhipeOdl24hO" alt=""><figcaption><p>Пример первого сообщения с кнопкой</p></figcaption></figure>
...
<figure><img src="/files/mrmNpp4X8Jp5gGXrfKiq" alt=""><figcaption></figcaption></figure>

Стрелка, которая пропускает тех, кто пришел из Вайбера выглядит следующим образом:

<figure><img src="/files/1dkKi9DsBJofcKj9oaNJ" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/chatbots/channels/viber.md?ask=<question>
```
