> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/channels/telegram/api/group.md).
...
<figure><img src="/files/14DeVI4OV1oWmnTLNdIc" alt=""><figcaption></figcaption></figure>
...
<table><thead><tr><th width="283.67578125">Параметр</th><th>Описание</th></tr></thead><tbody><tr><td><mark style="color:red;"><strong>!</strong></mark><strong> platform_id</strong></td><td>идентификатор чата в Telegram <a href="#gde-vzyat-platform_id-dlya-otpravki-uvedomlenii"><strong>*</strong></a></td></tr></tbody></table>
...
\&#xNAN;***upload\_photo*** для фотографий, \
\&#xNAN;***record\_video*** или ***upload\_video*** для видео , \
\&#xNAN;***record\_voice*** или ***upload\_voice*** для голосовых заметок, \
\&#xNAN;***upload\_document*** для общих файлов, \
\&#xNAN;***choose\_sticker*** для стикеров, \
\&#xNAN;***find\_location*** для данных о местоположении, \
\&#xNAN;***record\_video\_note*** или ***upload\_video\_note*** для видеозаметки.&#x20;
...
<figure><img src="/files/nzEVM6q06MovqPvQm7BQ" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/yjaXQ7JFleW5lDtDWjFb" alt="" width="563"><figcaption></figcaption></figure>

Создадим блок с первостепенной проверкой условия и в условие пишем желаемый текст. В нашем случае “первая”:

<figure><img src="/files/FqzdfpELBxi1wEQkGc0Z" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/j6V2RgbGpbecP479Oor2" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/VoGp6HZeip3Y2Fn4j0O8" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/AoyVIyq5iNoZncijD4Si" alt="" width="375"><figcaption><p>В случае нажатия на кнопку при таких <br>параметрах на несколько секунд появится <br>уведомление такого вида. </p></figcaption></figure>
...
<figure><img src="/files/0s0eF6Kiivfq6cPK5CvP" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/h7oq5xqTe1LcbVd14MRb" alt=""><figcaption></figcaption></figure>

В данном примере помимо перечисленных прав будут по умолчанию выданы права can\_manage\_chat.

<figure><img src="/files/131YfYXu5vzE6oWsf97N" alt=""><figcaption><p>Назначение прав пользователю</p></figcaption></figure>

<figure><img src="/files/Rxh5qosVk0xZk1VFOtVr" alt=""><figcaption><p>Установка титула администратору</p></figcaption></figure>
...
| Параметр                                                    | Описание                                                                                                                                                                                                                    |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <mark style="color:red;">**!**</mark>**&#x20;platform\_id** | идентификатор чата внутри Telegram [**\***](#gde-vzyat-platform_id-dlya-otpravki-uvedomlenii)                                                                                                                               |
| <mark style="color:red;">**!**</mark>**&#x20;user\_id**     | идентификатор пользователя внутри Telegram [**\***](#gde-vzyat-platform_id-dlya-otpravki-uvedomlenii)                                                                                                                       |
...
| **permission**                                              | массив значений [для списка ограничений](#spisok-ogranichenii-permission)                                                                                                                                                   |
...
<figure><img src="/files/JFjBZy84aGhEtKLOPHBx" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/fSzuNhm57ckaLe4YmwRP" alt=""><figcaption></figcaption></figure>
...
<table><thead><tr><th width="311.3359375">Параметр</th><th>Описание</th></tr></thead><tbody><tr><td><mark style="color:red;"><strong>!</strong></mark><strong> platform_id</strong></td><td>идентификатор чата внутри Telegram <a href="#gde-vzyat-platform_id-dlya-otpravki-uvedomlenii"><strong>*</strong></a></td></tr></tbody></table>
...
<figure><img src="/files/C5sgQ9U2pMX1SfQ9ZbTL" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/65zDoNQWEh9ZisHTXR1o" alt=""><figcaption><p>Пример колбека при добавлении опроса в канал</p></figcaption></figure>

<figure><img src="/files/BJfZRGyQi9ULHfChKRfK" alt=""><figcaption><p>Пример колбека при добавлении опроса в чат</p></figcaption></figure>
...
<figure><img src="/files/hwWYlMYQo85dkdfjOjiN" alt=""><figcaption><p>Функция создания опроса в Telegram</p></figcaption></figure>

<figure><img src="/files/zhmr7Xsq2gpON0jhOasS" alt=""><figcaption><p>Созданный нами опрос в Telegram</p></figcaption></figure>
...
<figure><img src="/files/cnsz7lOoyzZfjSJMbha7" alt=""><figcaption><p>Пример колбека в </p></figcaption></figure>
...
<figure><img src="/files/pw2mtbvS0wrJo82UvWz5" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/vA1gBuxI5sjpN5jNhk0g" alt=""><figcaption><p>Колбек на выбор ответа в Викторине </p></figcaption></figure>
...
<figure><img src="/files/DxfzRu48rwNEmc51pfCY" alt=""><figcaption><p>Изменение названия главной Темы</p></figcaption></figure>

<figure><img src="/files/wMbioOhSqSoIkZ8ygN0g" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/aWk4I13HvUQAltNLHXSD" alt=""><figcaption><p>Создание новой темы</p></figcaption></figure>
...
<figure><img src="/files/We7wwrYRFnlanuh4Kthg" alt=""><figcaption><p>Сохраняем из ответа функции по созданию идентификатор дополнительной темы </p></figcaption></figure>

<figure><img src="/files/7ZrdgNvhdk9hECDQoccV" alt=""><figcaption><p>Скрин Карточки клиента, раздел Переменные</p></figcaption></figure>
...
<figure><img src="/files/4aD1fygJsi51CwIGgZG8" alt=""><figcaption><p>Получение списка эмодзи</p></figcaption></figure>
...
```
GET https://docs.salebot.pro/chatbots/channels/telegram/api/group.md?ask=<question>
```
