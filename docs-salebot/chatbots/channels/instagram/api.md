> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/channels/instagram/api.md).
...
<figure><img src="/files/RuhS1rKWcUs3VY8sTG1S" alt=""><figcaption><p>Перечень локалей, применяемых в Facebook</p></figcaption></figure>
...
<figure><img src="/files/24A9Hnwe7DCpnXTa5GS5" alt=""><figcaption><p>login</p></figcaption></figure>
...
```
GET https://docs.salebot.pro/chatbots/channels/instagram/api.md?ask=<question>
```
