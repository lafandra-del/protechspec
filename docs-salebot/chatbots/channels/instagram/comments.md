> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/channels/instagram/comments.md).

# Как работать с комментариями

## Колбек **client\_wall\_reply\_new**

{% hint style="danger" %} <mark style="color:red;">**\***</mark>**Принадлежат компании Meta Platforms Inc**., деятельность которой признана **на территории Российской Федерации&#x20;**<mark style="color:red;">**экстремистской и**</mark> <mark style="color:red;">**запрещена!**</mark>&#x20;
{% endhint %}
...
И подключаете аккаунт Instagram<mark style="color:red;">\*</mark> заново. Как подключить Instagram<mark style="color:red;">\*</mark>смотрите [здесь ](#kak-podklyuchit-messendzher-videoinstrukciya)
...
<figure><img src="/files/aXr5XP6dEkUCqtaXOnoF" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/uMWeELHoPK95GtbYFYmE" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/rGkGp2ZnAt0GP3WItk0M" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Vnqe40EN75F1rQedT0R1" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/8JThCb9IAxIy80aiHmGz" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/yCKTvJyQG1VrqmsbYLtO" alt=""><figcaption><p>Ошибка, если в ответ на комментарий отправить больше одного сообщения</p></figcaption></figure>
...
<figure><img src="/files/zWk8Zw3rSe3PpTLBkbXL" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/d40zP8GCNlKaO5LYkI4O" alt=""><figcaption></figcaption></figure>
...
**Шаг 2.** В поле "Калькулятор" мы объявим переменную text. Значение переменной определим с помощью проверки условия IF, в зависимости от значения переменной ***instagram\_media\_url***&#x20;

*Пример для копирования. Не забудьте заменить ссылки на ваши актуальные. Скопировать можно в переменной **instagram\_media\_url** в диалоге с клиентом (раздел Клиенты) после комментирования нужного поста :*&#x20;
...
<figure><img src="/files/9xOY4HRVnouxKFEH4PE4" alt="" width="563"><figcaption></figcaption></figure>

*<mark style="color:green;">**Ответ бота на КОНКРЕТНУЮ ФРАЗУ под КОНКРЕТНЫМ постом.**</mark>*
...
<figure><img src="/files/DYIDiDJzknStOx1qTHUI" alt="" width="563"><figcaption></figcaption></figure>
...
#### *<mark style="color:green;">**Ответ бота на ЛЮБОЙ комментарий под КОНКРЕТНЫМ постом.**</mark>*
...
<figure><img src="/files/V5zEuIPKM8KeNeK7BCwo" alt="" width="563"><figcaption></figcaption></figure>

Тогда конкретно под этой записью будет приходить автоматический ответ на любой комментарий:

<figure><img src="/files/5qrdNc0pGgq2L67jbsGP" alt="" width="375"><figcaption><p>Пример ответа на любое сообщение под конкретным постом</p></figcaption></figure>

#### *<mark style="color:green;">**Ответ бота на ЛЮБОЙ комментарий под ЛЮБЫМ постом.**</mark>*
...
<figure><img src="/files/DqP6tDC8S3gSF1RDNMm8" alt="" width="563"><figcaption></figcaption></figure>

*<mark style="color:green;">**Ответ бота на КОНКРЕТНУЮ ФРАЗУ под ЛЮБЫМ постом.**</mark>*
...
<figure><img src="/files/div18ELsnj2Wb8Ll8fw1" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/4vHhIJDCh4ZCxXSlgK1G" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Anb0GzR2Sy4HYTeudAV5" alt="" width="375"><figcaption></figcaption></figure>

<figure><img src="/files/A2DSLxNz7J1heHrPRYui" alt="" width="375"><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/chatbots/channels/instagram/comments.md?ask=<question>
```
