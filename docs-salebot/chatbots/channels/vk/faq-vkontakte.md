> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chatbots/channels/vk/faq-vkontakte.md).
...
<div><figure><img src="/files/HzuLwkM1bK0xGdiSAZSW" alt="" width="339"><figcaption></figcaption></figure> <figure><img src="/files/TMkvPBXwOLnUobeDbAfI" alt="" width="322"><figcaption></figcaption></figure></div>
...
```
GET https://docs.salebot.pro/chatbots/channels/vk/faq-vkontakte.md?ask=<question>
```
