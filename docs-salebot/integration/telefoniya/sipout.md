> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/telefoniya/sipout.md).
...
![Настройки при подключении Bitrix24](/files/gLX9B5A3BmJpjbkLAPnr)

![Настройки при подключении AMO CRM](/files/2TetroPtOdySwpAPzQFc)
...
```
GET https://docs.salebot.pro/integration/telefoniya/sipout.md?ask=<question>
```
