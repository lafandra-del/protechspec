> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/telefoniya/megafon.md).
...
Адрес вашей CRM - <https://chatter.salebot.pro/megafon_webhook> (для получения уведомлений о звонках).
...
```
GET https://docs.salebot.pro/integration/telefoniya/megafon.md?ask=<question>
```
