> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/google/google-tablicy.md).
...
![](/files/-MfJk9FYsMsjdBA2rXiV)

![](/files/-MfJkYjZ3fr1dN0b4ci7)

![](/files/-MfJktTjeORXvQzyfoK1)
...
<figure><img src="/files/5wZgekpra06JoCoupHSx" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/JDrJ3Jh7ANItyczDdPiB" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/bDNoMrNgO2MqhTDkjxTV" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/ecNdJvWONZc18775Z1c9" alt=""><figcaption><p>Пример записи данных в первуюпустую ячейку 8 строки</p></figcaption></figure>
...
<figure><img src="/files/oGOBzIrstYGgIu3lZhYJ" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/fO8tBlWXIxlQ0bp0hdUL" alt=""><figcaption><p>Пример чтения из таблиц</p></figcaption></figure>
...
<figure><img src="/files/23itOw51x963r98tuEid" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/EEkFlsrYdmMnc3agHDRC" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Xwur31d612SLxlwmR2kc" alt=""><figcaption></figcaption></figure>
...
![](/files/SJOAnrYbOFpmWk57M0tI)

Результат работы:

![](/files/-M6nL1FwkS55jfKhOAFV)
...
![](/files/H4xbE2LNKQI9GKJpRIKy)

![](/files/ejQsw2WXFWz1KCr3jg62)
...
<figure><img src="/files/lkEKfcqBfLVldIHxJQun" alt=""><figcaption><p>Удаление листа из Google-таблицы</p></figcaption></figure>
...
<figure><img src="/files/gQneHWWORA7ejn7Y9syM" alt=""><figcaption><p>Получение общего числа листов в Google-таблице</p></figcaption></figure>
...
<figure><img src="/files/60yyKimcy41KX4TdoWb0" alt=""><figcaption><p>Переименование листа в Google-таблице</p></figcaption></figure>
...
<figure><img src="/files/bIlmvVn5r90eXqsCh8S3" alt=""><figcaption><p>Пример записи на первый лист таблицы</p></figcaption></figure>
...
<figure><img src="/files/USnP5kl16vQMdclGISq9" alt=""><figcaption><p>Пример с указанием названия листа для записи</p></figcaption></figure>
...
![Таблица для поиска](/files/SoIQkCtcEsmvAMCqKbRz)
...
![диапазон-источник данных sourseSheet\_data \[0,5,0,6\]](/files/3b6dQgvxwjpTgLbW9Pgc)

![диапазон-приемник данных destinationSheet\_data \[0,3,0,2\]](/files/Emwl77QbOWNTAA03AivG)
...
![диапазон-приемник данных destinationSheet\_data \[1,10,1,7\]](/files/BpMFhIAPTL7qaIgHuJvb)

![](/files/BsfcAT3ZVaDRerxQ8Isy)

![](/files/WlUvKq4UX5XibLZycG0V)
...
![](/files/PquQeUenCkxiQQXMNLj2)

![диапазон-приемник данных destinationSheet\_data \[1,6,1,7\]](/files/YWJzAj48yxZ2ntdUQgWU)
...
```
GET https://docs.salebot.pro/integration/google/google-tablicy.md?ask=<question>
```
