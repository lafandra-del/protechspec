> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/infobiz/getcourse.md).
...
Подробнее по ссылке: <https://docs.salebot.pro/kursy>&#x20;

* [Как настроить Getcourse ](#undefined)
* [Как создать в Getcourse дополнительное поле клиента (Salebot client\_id) ](#sozdanie-v-getcourse-dopolnitelnogo-polya-klienta-sb_id)
* [Как добавить пользователя ](#dobavlenie-polzovatelya)
* [Как добавить заказ ](#dobavlenie-zakaza)
* [Как редактировать заказ ](#redaktirovanie-zakaza)
* [Как изменить статус заказа](#kak-izmenit-status-zakaza)
* [Как отправить вебхук из Геткурс ](#otpravka-vebkhuk-iz-getkurs)
* [Как передать Salebot client\_id при регистрации клиента через лендинг Getcourse](#peredat-salebot-client_id-pri-registracii-klienta-cherez-lending-getcourse)
...
<figure><img src="/files/mP6yJgtkwlCuI1sfVJnR" alt=""><figcaption><p>Включите чтение и запись перед созданием ключа.</p></figcaption></figure>
...
![](/files/avX6sdCbYL1AZzoWnvhE)

![](/files/-MkkihTW5MKh7M-FRiq1)
...
<figure><img src="/files/Nc7Rotzwphlrf8AeAgGX" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/OUT13dxNhIJMB6eHBdST" alt=""><figcaption></figcaption></figure>
...
<https://chatter.salebot.pro/getcourse\\_webhook/>*<mark style="color:green;">Ключ доступа к API из настроек проекта Salebot</mark>*?phone={object.user.phone}\&callback\_text=send&… &#x20;

(также рекомендуется добавить емейл \&email={object.user.email})

**При настройке процесса по пользователям:**

<https://chatter.salebot.pro/getcourse\\_webhook/>*<mark style="color:green;">Ключ доступа к API из настроек проекта Salebot</mark>*?phone={object.phone}\&callback\_text=send&…&#x20;
...
<https://chatter.salebot.pro/getcourse\\_webhook/>*<mark style="color:green;">Ключ доступа к API из настроек проекта Salebot</mark>*?client\_id={object.user.sb\_id}\&callback\_text=any\_message&… - &#x20;

(также рекомендуется добавить емейл \&email={object.user.email})

**При настройке процесса по пользователям:**

<https://chatter.salebot.pro/getcourse\\_webhook/>*<mark style="color:green;">Ключ доступа к API из настроек проекта Salebot</mark>*?client\_id={object.sb\_id}\&callback\_text=any\_message&…&#x20;
...
*<mark style="color:green;">Ключ доступа к API из настроек проекта Salebot</mark>*  - вместо этого вставьте токен из раздела Настройки проекта в Salebot&#x20;
...
<figure><img src="/files/WYFaPacaw36fA1BJKi5f" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/infobiz/getcourse.md?ask=<question>
```
