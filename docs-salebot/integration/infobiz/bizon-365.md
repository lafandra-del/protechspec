> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/infobiz/bizon-365.md).
...
* [Как настроить bizon365 ](#nastroiki-na-storone-bizon365)
* [Как регистрировать на вебинар из чат-бота ](#registraciya-na-vebinar-iz-chat-bota)
* [Как проверить посещение вебинара ](#proverka-posesheniya-vebinara)
* [Как зарегистрировать на вебинар, используя страницу регистрации](#registraciya-na-vebinar-ispolzuya-stranicu-registracii)
...
<figure><img src="/files/on1HPQxFx7QR45o8VSI8" alt=""><figcaption></figcaption></figure>

Нажмите на "Изменить и настроить доступ"

<figure><img src="/files/DK6TJV4hvIb3ARmZQGqb" alt=""><figcaption></figcaption></figure>

Нажмите на "Генерировать" в строке "API-токен" (если у вас еще не было токена) и скопируйте его:

<figure><img src="/files/uzaq0BDjhJMzjkt74y0K" alt=""><figcaption></figcaption></figure>

**После получения токена, переходим в настройки проекта -> Переменные проекта и сохраняем его в переменную bizon365\_token**

<figure><img src="/files/eRGVYoeqIsQjwnJSulaX" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/gvNAO01NhALaTmwXDpWR" alt=""><figcaption></figcaption></figure>

Далее в открывшемся окне нажмите на "Сгенерировать", далее активируйте переключатели для клиентов и для интеграции:

<figure><img src="/files/w7JLvOX0uTPY00elGMge" alt=""><figcaption></figcaption></figure>

Затем пропишите название токена и нажмите "Готово":

<figure><img src="/files/Ng56zLiDoG2DUY7qCHFo" alt="" width="563"><figcaption></figcaption></figure>

Появится ключ, который можно копировать и изменять при необходимости:

<figure><img src="/files/QcipErbt34G0fTz55k4A" alt=""><figcaption></figcaption></figure>

Этот ключ используйте для формирования адреса для вебхуков:

**<https://chatter.salebot.pro/bizon\\_webhook/>**<mark style="color:red;">**Ваш\_ключ\_к\_АПИ**</mark>, где вместо <mark style="color:red;"><Ваш\_ключ\_к</mark>*<mark style="color:red;">\_</mark>*<mark style="color:red;">АПИ></mark> вставляете полученный в настройках проекта ключ.
...
<figure><img src="/files/TK7VHVdecyffeVgJy998" alt=""><figcaption></figcaption></figure>

Далее после созания страницы нажмите "Настроить":

<figure><img src="/files/3cCpyCyAiK7jfVkrYIB7" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/ejIPaR5jU7WqPeJdLhjA" alt=""><figcaption></figcaption></figure>

**Заполните обязательные поля:**

<figure><img src="/files/eAqDICwQIT0v30Tpdzen" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/sKjGx0xF5xDtNWMB7DTO" alt=""><figcaption></figcaption></figure>

Далее в настройках комнаты перейдите во вкладку "Доступ":

<figure><img src="/files/O7FlGPA9KclNiA1PTkoH" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/0XMEHJfPlh1l88gMltmq" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/iKDTscPm62POdxtL5IZK" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/T7SqnTibXrO0D9rfOKXj" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/BglngEm3FCJmxn22Jhcj" alt=""><figcaption></figcaption></figure>

При переходе при клике на кнопку в мессенджере, пользователь попадет на вебинар:

<figure><img src="/files/SmY7Dc38cgSufzcKATfL" alt="" width="563"><figcaption></figcaption></figure>

<figure><img src="/files/SlTLsF8qLTGbigVsTIt0" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/VHXh5ScOXJKqfOMQPatJ" alt=""><figcaption></figcaption></figure>

И копируем одну из ссылок **Адрес страницы:**

<figure><img src="/files/iXM96nRVPAAOWFHmIdqN" alt=""><figcaption></figcaption></figure>
...
<https://start.bizon365.ru/page/222222/yourpag&#x65;**?salebot=#{client\\_id}**&#x20>;
...
<figure><img src="/files/iyz6mvhUalffClA5VjQ6" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/KdqLknF0u4C8oqDqs1tJ" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Q0n9fJKNg3cwCZGUHrta" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/h2Io5VStBQsq2ToYX6nw" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/0yChdEETO8oaLL8fJl12" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/8wIhxPNoEf2fihlEouaa" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/T2t8TNc2OKD5IMmbOdD6" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/a61kciIHBLxGjZQ2ByUf" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/610tmhu5FxOqjtlP5WJR" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/cAddPX8U8mrHx5dG1HOw" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/PCVyCbDiDPk8eR6reBuf" alt="" width="563"><figcaption></figcaption></figure>

Все возможные данные и их обозначения, которые могут быть в переменной b365\_viewer, можно посмотреть перейдя по ссылке: <https://blog.bizon365.ru/api/v1/webinars/reports/#getviewers> . Они указаны после строки “Поле **viewers** — это массив, состоящий из объектов следующего формата:".
...
<figure><img src="/files/vBXc5x1s1NPxyxQpfhna" alt=""><figcaption></figcaption></figure>

Нажмите "+ Добавить переменную":

<figure><img src="/files/S0lwxVpAufDXDovnmzO2" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/a3gNhjGunltIgeDpYroA" alt=""><figcaption></figcaption></figure>

Далее перейдите в раздел "Доступ"  и отметьте галочками поля "Номер телефона" и "Обязательное поле":

<figure><img src="/files/LOpNrcdB4UvtOLJByHJD" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/infobiz/bizon-365.md?ask=<question>
```
