> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/google.md).
...
<figure><img src="/files/044Ej3VLe7qgUtLQAb2U" alt=""><figcaption></figcaption></figure>

2\. Придумайте название, но <mark style="color:red;">НЕ указывайте организацию.</mark> Нажмите Create

<figure><img src="/files/WoWrtoB0E6YC1bTviuzM" alt=""><figcaption></figcaption></figure>

3\. Проверьте права доступа: должен быть уровень доступа “owner”

<figure><img src="/files/gOszu5JxPbVdvGFijpOS" alt=""><figcaption></figcaption></figure>

&#x20;

<figure><img src="/files/NsmfBZIsKD8noifZgrIq" alt=""><figcaption></figcaption></figure>

4\. Перейдите во вкладку Service Accounts и создайте сервисный аккаунт Create Service Account.&#x20;

<figure><img src="/files/3ngzsDQeVYGfFzIiHH3v" alt=""><figcaption></figcaption></figure>

Укажите имя в первом пункте:

<figure><img src="/files/gWb3KqNguwKBFimeRWmL" alt=""><figcaption></figcaption></figure>

&#x20;Выставьте права Owner во втором пункте и пропустите третий. Нажимаем Done.

<figure><img src="/files/ocOSDA3klxWcy02WZAv9" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/PlcQN5OLgfctbkYZrPWS" alt=""><figcaption></figcaption></figure>

Создайте новый ключ. Выберите параметр JSON в качестве сохранения.

<figure><img src="/files/wm8QGa7NJEIB4jZhA1lT" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/I4W2ifTn5HjzvRrPfXAK" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/DpVeltPpU7dTcXJcqjsS" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/b872JD2epBkjxI8S6naZ" alt=""><figcaption></figcaption></figure>

Необходимо выбрать “APIs & Services”, далее “Enabled Api’s and services” и нажать "enable Apis and services".

<figure><img src="/files/VsrwP0tgV54j21BiaZEX" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/2LP0EWy5BZmiTvEvk0p9" alt=""><figcaption></figcaption></figure>

Включите нужные нам сервисы APi - Google Drive Api и Google Docs API (не забудьте развернуть список)

<figure><img src="/files/ORdi7kfj5v2yedEvIR9e" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/aiOeYHHi2dtONWphonwM" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/fafI7bG0eiX2N5AstP1W" alt=""><figcaption></figcaption></figure>

Проверяем:

<figure><img src="/files/yBe2wt79vWDI5efm0bAj" alt=""><figcaption></figcaption></figure>

В дальнейшей работе вам потребуется ID файла, который мы копируем из адресной строки

<figure><img src="/files/SXFF7L2glNRLCEqpouUV" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/2hGv18HWTmUU0NXAtJm3" alt=""><figcaption></figcaption></figure>

Откройте вложенный документ: для этого щелкните на иконке документа. В открывшемся окне заберите ссылку из адресной строки:

<figure><img src="/files/kE4TeTDh9ojrPDJZukfH" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/uZlmfvBkbfDIXAcEIpdl" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/google.md?ask=<question>
```
