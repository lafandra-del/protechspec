> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/tinkoff.md).
...
<figure><img src="/files/SRJmj2kyNYnnfohYqmKi" alt="" width="563"><figcaption><p>Рис. 1. Форма подключения эквайринга от Т-банка на стороне Сейлбот</p></figcaption></figure>
...
<figure><img src="/files/PeGqSFZRcPi5Pe6N7syr" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/vGhOldWlOx6SQ374MPAT" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/lOMyQpII8W3Y0l24tDJ7" alt=""><figcaption><p>Рис. 7. Переменные сделки</p></figcaption></figure>
...
<figure><img src="/files/TFhVUUyeamQehnPwj40w" alt="" width="563"><figcaption><p>Рис. 8. Форма для настройки кнопки оплаты в боте</p></figcaption></figure>
...
<figure><img src="/files/sbKswhKNMEWLmsL21rZn" alt=""><figcaption><p>Рис. 9. Уведомление о клике</p></figcaption></figure>
...
<figure><img src="/files/iHCHYbLRcmPgGLhb7Af5" alt="" width="563"><figcaption><p>Рис. 10. Меню настроек кнопки Оплата: "Данные для формирования чека"</p></figcaption></figure>
...
<figure><img src="/files/xOgygvRfNtgmYp27hxFl" alt="" width="563"><figcaption><p>Рис. 11. Меню дополнительной информации</p></figcaption></figure>
...
<figure><img src="/files/fNsW5irta7nJ9XMGhKJH" alt=""><figcaption><p>Рис. 12. Пример № 1. Колбэк об успешной оплате в поле Условие блока "Стартовое условие"</p></figcaption></figure>

<figure><img src="/files/j6j59scYvLW9s1M8tngs" alt=""><figcaption><p>Рис. 13. Пример № 2. Колбэк об успешной оплате в поле Условие блока "Не состояние с условием"</p></figcaption></figure>
...
<figure><img src="/files/0ZJvjGs8EIpemh4JTyVj" alt=""><figcaption><p>Рис. 12. Пример № 1. Колбэк об ошибке платежа в поле Условие блока "Стартовое условие"</p></figcaption></figure>
...
<figure><img src="/files/FOqnDlyS4LCCQW1y5Ndz" alt=""><figcaption><p>Рис. 13. Пример формирования ссылки: переданы только обязательные параметры</p></figcaption></figure>

Пример 2:&#x20;

<figure><img src="/files/lukq6eb1RV7vhwu2tuPD" alt="" width="563"><figcaption><p>Рис. 14. Пример формирования ссылки: переданы все параметры</p></figcaption></figure>
{% endtab %}
...
<figure><img src="/files/2HkCWKVrn8XnufcWHFoj" alt=""><figcaption><p>Рис. 15. Пример функции tinkoff_sm_register_get_shop_code с заполненными параметрами</p></figcaption></figure>
...
<figure><img src="/files/R2K2ap7J3BCJCS7wI3uU" alt="" width="563"><figcaption><p>Рис. 16. Пример использования переменных в калькуляторе</p></figcaption></figure>
...
<figure><img src="/files/XSTMtZQRchz5HWr5P3sH" alt="" width="563"><figcaption><p>Рис. 17. Пример оплаты</p></figcaption></figure>
...
<figure><img src="/files/2X0JzBWtQRxrncyWvMrG" alt=""><figcaption><p>Рис. 19. Пример настройки блока</p></figcaption></figure>
...
<figure><img src="/files/UfdyqiuDJucpdHFxuXGj" alt="" width="450"><figcaption><p>Рис. 20. Колбек об успешной оплате</p></figcaption></figure>

Шаг 2. Создаем блок с условием (Стартовое условие или Не состояние с условием) и указываем в поле "Условие" колбек:

<figure><img src="/files/wR5i37RYZrvlpnBYlZNS" alt=""><figcaption><p>Рис. 21. Настройка блока "Стартовое условие"</p></figcaption></figure>

<figure><img src="/files/3URAgNWf3NMPp8KYvOAv" alt=""><figcaption><p>Рис. 22. Настройка блока "Не состояние с условием"</p></figcaption></figure>
...
<figure><img src="/files/XT3aGBhryoMBAeUShX6x" alt="" width="563"><figcaption><p>Рис. 23. Пример в калькуляторе передачи параметров</p></figcaption></figure>
...
<figure><img src="/files/z12KuGycqRi8t7zOuAhX" alt="" width="563"><figcaption><p>Рис. 24. Пример передачи переменых</p></figcaption></figure>
...
<figure><img src="/files/BrxqweIgKm9tFLNcEx1E" alt=""><figcaption><p>Рис. 25. Личный кабинет Т-банка: вкладка Автоплатежи -данные для прохождения тестов</p></figcaption></figure>
...
<figure><img src="/files/nM5wZjtL8Xv5MmIzdTyu" alt=""><figcaption><p>Рис. 26. Настройка блока для оплаты</p></figcaption></figure>
...
<figure><img src="/files/Lo0RilfLpQFj2H71uDKs" alt=""><figcaption><p>Рис. 27. Настройки блока для автосписания</p></figcaption></figure>
...
<figure><img src="/files/ORItFwPAEPmYRIxtghhD" alt=""><figcaption><p>Рис. 29. Пример в калькуляторе</p></figcaption></figure>
...
<figure><img src="/files/4s4N8p2ajMDZ9ywWoYcT" alt=""><figcaption><p>Рис. 30. Отмена автоплатежа</p></figcaption></figure>
...
<figure><img src="/files/Tdx4xQyR0pTX6oGYKjr1" alt=""><figcaption><p>Рис. 31. Калькулятор в блоке</p></figcaption></figure>
...
<figure><img src="/files/SRJmj2kyNYnnfohYqmKi" alt="" width="563"><figcaption><p>Рис. 32. Форма подключения эквайринга от Т-банка на стороне Сейлбот</p></figcaption></figure>

Шаг 2. В настройках курса выбираем платежную систему&#x20;

<figure><img src="/files/TdK2vxnX7mxu7rlPir8P" alt=""><figcaption><p>Рис. 33. Выбираем платежную систему в разделе "Оплата" в настроках курса</p></figcaption></figure>

Шаг 3. Создаем тариф

<figure><img src="/files/sR2eGXvRx2GFj4pOcfRp" alt=""><figcaption><p>Рис. 34. Создание виджета в настройках курса</p></figcaption></figure>
...
<figure><img src="/files/MwNAyxDDP04ICNNWDt6e" alt="" width="563"><figcaption><p>Рис. 35. Настройка терминала</p></figcaption></figure>
...
<figure><img src="/files/euTPFoH21cUf7MKhGhmp" alt=""><figcaption><p>Рис. 36. Тариф на странице курса</p></figcaption></figure>

Далее ученику нужно будет ввести свои данные:

<figure><img src="/files/REB651rt9LxNmNE2z5Vy" alt="" width="563"><figcaption><p>Рис. 37. Форма для заполнения данных при покупке учеником курса</p></figcaption></figure>

<figure><img src="/files/aQW3PBuMGuczk0TR3dGP" alt="" width="563"><figcaption><p>Рис. 38. Форма оплаты</p></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/payments/tinkoff.md?ask=<question>
```
