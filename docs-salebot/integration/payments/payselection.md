> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/payselection.md).
...
Ссылка имеет вид: \
<https://webform.payselection.com/pay/421092b3-40c5-404e-afe0-1417cf64538b&#x20>;
...
```
GET https://docs.salebot.pro/integration/payments/payselection.md?ask=<question>
```
