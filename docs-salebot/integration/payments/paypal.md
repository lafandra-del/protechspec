> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/paypal.md).

# Paypal

* [Как настроить Paypal ](#kak-nastroit-paypal)
* [Как создать ссылку на оплату ](#sozdanie-ssylki-na-oplatu)
* [Как создать реккурентный платеж](#kak-sozdat-rekkurentnyi-platezh)
...
<figure><img src="/files/1cuFRDUdlqYCDB9kyEcx" alt="" width="563"><figcaption><p>Создание предложения для подписки в пейпал</p></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/payments/paypal.md?ask=<question>
```
