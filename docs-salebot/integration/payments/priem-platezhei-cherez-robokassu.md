> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/priem-platezhei-cherez-robokassu.md).
...
<figure><img src="/files/w4Zj0FaZ8D8crzNDk5mc" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/vCVKx5KxZDnjPf8W7nTl" alt="" width="297"><figcaption><p>Рис. 2</p></figcaption></figure>

&#x20;Найдите кнопку Robokassa для подключения сервиса:

<figure><img src="/files/7sGxMaL5Uur69DbU541Z" alt=""><figcaption><p>Рис. 3</p></figcaption></figure>

и заполните форму в открывшейся форме:

<figure><img src="/files/O9emty84CphdFo9xSWN8" alt=""><figcaption><p>Рис. 4</p></figcaption></figure>
...
<figure><img src="/files/UN5wIhEU9oFnB4N2TxUB" alt="" width="563"><figcaption><p>Рис. 5. Выбор системы налогообложения для формирования чека об оплате</p></figcaption></figure>
...
<figure><img src="/files/tquRD66QUUsM1N9GxnJY" alt="" width="563"><figcaption><p>Рис. 6. Выбор доменной зоны</p></figcaption></figure>
...
<figure><img src="/files/SbTnVaozQsveYq2tIKAN" alt=""><figcaption><p>Рис. 7. Форма настройки кнопки оплаты в блоке чат-бота</p></figcaption></figure>
...
<figure><img src="/files/hJGUwXOC11FJzUTSzq0P" alt="" width="563"><figcaption><p>Рис. 8. меню "Данные для формирования чека" </p></figcaption></figure>
...
<figure><img src="/files/MnK4Kg5ik89wFB3P10qN" alt="" width="563"><figcaption><p>Рис. 9. переменная payments</p></figcaption></figure>
...
<figure><img src="/files/E5zXNyGeervZvmiQUQMS" alt="" width="563"><figcaption><p>Рис. 10. Блок "Стартовое условие" с кнопкой оплаты</p></figcaption></figure>

<figure><img src="/files/UgAeYEAOVBwc13xYbKi0" alt=""><figcaption><p>Рис. 11. Настройка кнопки</p></figcaption></figure>
...
<figure><img src="/files/DsSg6KM5zRJQNfuH2vYX" alt=""><figcaption><p>Рис. 12. Диалог с клиентом</p></figcaption></figure>

Колбек:

<figure><img src="/files/hP2i5CehmSF4SY7SqrDv" alt="" width="563"><figcaption><p>Рис. 13. Колбек</p></figcaption></figure>
...
<figure><img src="/files/CyS3WQgrY5NM9LluAg8f" alt=""><figcaption><p>Рис. 14. Реакция на колбек с помощью блока "Стартовое условие"</p></figcaption></figure>

Далее при оплате клиенту будет приходить сообщение из блока, в котором настроена реакция на коллбэк:

<figure><img src="/files/DsSg6KM5zRJQNfuH2vYX" alt=""><figcaption><p>Рис. 15. Диалог с клиентом</p></figcaption></figure>
...
<figure><img src="/files/LbYNOIUBjHWiWqa3i4Se" alt=""><figcaption><p>Рис. 16. Пример формирования ссылки: переданы только обязательные параметры</p></figcaption></figure>
{% endtab %}
...
<figure><img src="/files/6GuGUcTAn2tplR9V9uM6" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/2ecXJ0i4OYVyhBPy0sE4" alt=""><figcaption><p>Рис. 17. настройка блока "Стартовое условие" с ссылкой на оплату</p></figcaption></figure>

Отработка блока:

<figure><img src="/files/u3Q1E2qNRKPOzG2uWC9K" alt="" width="563"><figcaption><p>Рис. 18. Пример ссылки на оплату, отправляемой ботом. </p></figcaption></figure>
...
<figure><img src="/files/4fjg6KevJ6WiEs6kgudM" alt=""><figcaption><p>Рис. 19. Колбек об успешной оплате</p></figcaption></figure>

2. Ссылка в кнопке:

<figure><img src="/files/B3wpJZ0AL9O3Tmjqsv1N" alt=""><figcaption><p>Рис. 20. Кнопка с ссылкой на оплату</p></figcaption></figure>

Отработка блока:

<figure><img src="/files/3u2o2PAbDx6hukDdKJy6" alt="" width="563"><figcaption><p>Рис. 21. Пример отправки кнопки с ссылкой на оплату</p></figcaption></figure>

Коллбэк при успешной оплате:

<figure><img src="/files/bAbhbfpzANpp56OR3sc2" alt=""><figcaption><p>Рис. 22. Колбек об успешной оплате в диалоге с клиентом</p></figcaption></figure>
...
<figure><img src="/files/coDNjiYngTgmXBFtyp3r" alt=""><figcaption><p>Рис. 23.  Пример настройки блока "Стартовое условие"</p></figcaption></figure>

**ПРИМЕР отработки блоки (ссылки на оплату):**

<figure><img src="/files/YKOPJcI9291gjzE9YbrB" alt="" width="563"><figcaption><p>Рис. 24. Пример ссылки в боте.</p></figcaption></figure>
...
<figure><img src="/files/geOvXssYTmZsh4WYFHhR" alt=""><figcaption><p>Рис. 24. Пример настройки кнопки</p></figcaption></figure>
...
<figure><img src="/files/IQn1MhpkTuGtBjj6kvTw" alt=""><figcaption><p>Рис. 25. Пример колбека об успешной оплате</p></figcaption></figure>
...
<figure><img src="/files/vGQOHl6tq1tuMI34JvsA" alt=""><figcaption><p>Рис. 26. Настройка блока "Стартовое условие"</p></figcaption></figure>
...
<figure><img src="/files/31ovDWpRshZiC3dE1iiv" alt=""><figcaption><p>Рис. 27. Настройки стрелки</p></figcaption></figure>

Далее в следующем блоке оплаты добавьте кнопку и установите в строку url переменную **robokassa\_pay\_url:**

<figure><img src="/files/a8vklqRvoDY0Tgw1tQ77" alt=""><figcaption><p>Рис. 28. Настройки блока с кнопкой оплаты</p></figcaption></figure>

<figure><img src="/files/dvIIvkh1n1usGgb7vzSp" alt=""><figcaption><p>Рис. 29. Настройка кнопки</p></figcaption></figure>

Схема отработает следующим образом:

<figure><img src="/files/C7qXsgeGy4W7JcTWOMSt" alt="" width="563"><figcaption><p>Рис. 30. Пример отработки блоков</p></figcaption></figure>

При клике на кнопку сумма, которую прописал клиент, будет доступна к оплате в платежной форме:

<figure><img src="/files/E1hu3KLPQ61mNqPsDkaf" alt="" width="375"><figcaption><p>Рис. 31. Форма оплаты</p></figcaption></figure>

После оплаты придет коллбэк, на который также можно настроить реакцию.&#x20;

<figure><img src="/files/mXEUZVZ5NDHC8Kv0Gzvr" alt=""><figcaption><p>Рис. 32. Отправка колбека об успешной оплате</p></figcaption></figure>
...
<figure><img src="/files/fr73SKZhIPZEoBD3cbp6" alt=""><figcaption><p>Рис. 33. Пример настройки блока "Не состояние с условием" для реакции на успешную оплату</p></figcaption></figure>
...
<figure><img src="/files/Au9MkounJaUjywqnZIFF" alt=""><figcaption><p>Рис. 34. Как работает схема</p></figcaption></figure>
...
<figure><img src="/files/GB15Uco7X8DuwA8dplLQ" alt="" width="563"><figcaption><p>Рис. 35. Данные для формирования чека</p></figcaption></figure>
...
<figure><img src="/files/i9pq5KLqS4exwYNOH2Jw" alt=""><figcaption><p>Рис. 36. Выбор платежной системы в разделе "Оплата" в настройках курса</p></figcaption></figure>
...
<figure><img src="/files/yITt78VdgJdhEy5XN9H4" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/30S1bA2UBgcY6LB42OAZ" alt=""><figcaption></figcaption></figure>

Далее в настройках кнопки найдите чекбокс "Автоплатежи" и активируйте его:

<figure><img src="/files/eG6XJfcrb6iWR5LizHvg" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/gme1lBJMbT8L3UiDzYSe" alt=""><figcaption></figcaption></figure>
...
![](/files/7vsKKtESHZhee6DpnpOK)
{% endhint %}

<figure><img src="/files/87WDoNm804BvVs86p0r7" alt=""><figcaption><p>Пример формирования ссылки для обычного платежа</p></figcaption></figure>
...
<figure><img src="/files/LoOutX6JcqafAIzO04LL" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/yLL3D2TthZjoUmbgSNRf" alt="" width="533"><figcaption></figcaption></figure>
...
<figure><img src="/files/Fna0atskXttUQsLvszpQ" alt=""><figcaption><p>Петля - повторный переход в блок Автоплатёж</p></figcaption></figure>
...
<figure><img src="/files/F3y5c5O1zxKdmgyCecJ9" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/ktKK9pOI59s26iRRcBT7" alt=""><figcaption><p>Настройки блока для формирования ссылки на обычный платеж при включенных Автоплатежах</p></figcaption></figure>
...
<figure><img src="/files/yTlRX38VAEmMQHwEmomV" alt=""><figcaption><p>Robokassa рекомендует</p></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/payments/priem-platezhei-cherez-robokassu.md?ask=<question>
```
