> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/priem-platezhei-v-bote-cherez-yandeks.kassu.md).
...
<figure><img src="/files/iy5JS9uPap2DMzBE0BHW" alt="" width="563"><figcaption></figcaption></figure>

Либо в левом меню ЮKassa:

<figure><img src="/files/3wVSRFSKc476bXSF3UMh" alt=""><figcaption></figcaption></figure>

**Секретный ключ** находится в разделе Интеграция  → Ключи API:

<figure><img src="/files/oD1RlN7FHoE8EKizSd83" alt=""><figcaption></figcaption></figure>

Для того, чтобы бот получал уведомления об оплате, также необходимо установить на ЮKassa callback\_url <https://chatter.salebot.pro/yandex_kassa_callback/result>

Для этого нужно перейти в раздел "Интеграция" → "HTTP-уведомления"

<figure><img src="/files/FuiJMrHx5HCdbIj2JDRE" alt=""><figcaption><p>Настройки уведомлений</p></figcaption></figure>
...
<figure><img src="/files/VIDfsnUhO7ArkrRTD5C7" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/DnWQEJGFC4KJMOE7AcHP" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/w6byXjvA5xwsB6zzg0mf" alt="" width="563"><figcaption></figcaption></figure>
...
* [Функция `get_yookassa_payment_url` в Калькуляторе](#funkciya-get_yookassa_payment_url-v-kalkulyatore), или&#x20;
...
<figure><img src="/files/wqOUPS0uLIib2TueSHgx" alt="" width="551"><figcaption><p>Настройки кнопки</p></figcaption></figure>
...
Про настройки для автоплатежей можно почитать здесь: [Как подключить автоматические платежи](#kak-podklyuchit-avtomaticheskie-platezhi)

**чекбокс Двухстадийная оплата.** Данная функция нужная для того чтобы деньги не сразу отправлялись на счёт продавца, а сначала замораживались (холдировались). Такой платёж можно подтвердить или отменить. Подробнее как настроить двухстадийную оплату читайте здесь: [Двухстадийная оплата (холдирование)](#dvukhstadiinaya-oplata-kholdirovanie)
...
<figure><img src="/files/89iyE1x1PJ819sb9xLkv" alt="" width="549"><figcaption><p>Дополнительные настройки "Данные для формирования чека"</p></figcaption></figure>
...
<figure><img src="/files/immVetg0rc6MQ6CcnVrc" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/9cjd4VZ28bZWZMvqNRbq" alt=""><figcaption><p>Коллбэк об успешной оплате в поле Условие блока</p></figcaption></figure>
...
<figure><img src="/files/QbsLteBSWc5FPMKzfrBI" alt="" width="458"><figcaption></figcaption></figure>
...
<figure><img src="/files/oCHbojKTjjmCONMuA1Y0" alt=""><figcaption></figcaption></figure>

Если это кнопка для оплаты, то нужно поставить галочку "Двухстадийная оплата".&#x20;

<figure><img src="/files/yoAdJEQ5LaG5PdH7Dlr1" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/AZiG4rZgLbCumXaSR7Ad" alt=""><figcaption><p>вместо параметра payment_id сразу передана переменная yandex_payment_method_id_hold </p></figcaption></figure>
...
<figure><img src="/files/ynIigsesejxLcmV1vanv" alt=""><figcaption></figcaption></figure>

2. Далее в следующем блоке указываем переменную #{**yandex\_kassa\_pay\_url} через конструкцию #{} в вложении либо в кнопке:**

<figure><img src="/files/LZxRVr4x10yukL10wUzM" alt=""><figcaption><p>Пример: переменная <strong>yandex_kassa_pay_url лежит в поле url в настройках кнопки</strong></p></figcaption></figure>

<figure><img src="/files/TB4t60Ipen8on5SSjtCN" alt=""><figcaption><p>Пример: переменная <strong>yandex_kassa_pay_url лежит в поле url в настройках вложений</strong></p></figcaption></figure>
...
<figure><img src="/files/cNkEIpLAwToi11WA56av" alt="" width="563"><figcaption></figcaption></figure>

2. Если #{**yandex\_kassa\_pay\_url**} лежит в поле url настройки вложений, то придет ссылка для оплаты:

<figure><img src="/files/I2LqFRH3FD3Vy9QjjCXT" alt="" width="563"><figcaption></figcaption></figure>

И в первом, и во втором случае при клике на кнопку или переходе по ссылке, ваш клиент перенаправится на страницу оплаты:

<figure><img src="/files/LUluC4MXr8KCk2rjCwaW" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/WnIW81JeCIcbI8P4teyR" alt="" width="563"><figcaption></figcaption></figure>
...
*<mark style="color:blue;">Шаг 1. Включить автоплатежи в настройках ЮКассы в проекте Salebot.</mark>*
...
<figure><img src="/files/OPm28NA4uACakQMkaIza" alt="" width="563"><figcaption><p>Чекбокс "Включить автоплатежи" в настройках ЮKassa в разделе "Эквайринг" Salebot</p></figcaption></figure>

В этом случае при оплате сервис ЮKassa предложит разрешить автосписания:

<figure><img src="/files/yHGWZhAijAFBBbER5dok" alt="" width="465"><figcaption></figcaption></figure>

При переходе по ссылке ЮKassa объяснит[ как работают автосписания](https://yoomoney.ru/page?id=529482).

*<mark style="color:blue;">Шаг 2. Провести обычный платёж.</mark>*
...
<figure><img src="/files/sZDFzs7gA4E5MjdvDO0p" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/MQOE3YEaxM5EzhUcXc5u" alt="" width="499"><figcaption></figcaption></figure>
...
*<mark style="color:blue;">Шаг 3. Планируем автосписание</mark>*
...
<figure><img src="/files/HcDLySLS19maDyV5rU4D" alt=""><figcaption></figcaption></figure>

*<mark style="color:blue;">Шаг 4. Планируем регулярные списания и настраиваем возможность отказаться от автосписаний.</mark>*
...
<figure><img src="/files/lmqx6Y6LE0pFAHiEOG42" alt=""><figcaption></figcaption></figure>

{% hint style="info" %}
Для тестирования платежа вам необходимо перейти по ссылке для оплаты, выбрать средство платежа и оплатить
{% endhint %}

<div align="left"><figure><img src="/files/9DcB8XZ9DgomUgoD0J97" alt="" width="529"><figcaption></figcaption></figure> <figure><img src="/files/bjLkBTMKKJ2gttEGcDUx" alt="" width="558"><figcaption></figcaption></figure></div>

После успешной оплаты сможете посмотреть информацию о платеже:

<figure><img src="/files/BXjE7MrXdJNFCqufnRxi" alt="" width="563"><figcaption></figcaption></figure>

{% hint style="warning" %}
При выполнении автоплатежа не должно быть ссылки на оплату ЮКассы и переменной **payment\_sum**!
{% endhint %}

<figure><img src="/files/GijIqG5sMPWLLdoD0VIE" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/LWTfesvku3pMVFcJT6GE" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/LU3xrAHIuIVeyPuSJURs" alt=""><figcaption></figcaption></figure>

После определения переменных платежа, определяем переменную payment\_sum, после которой сразу появится ссылка на оплату.

<figure><img src="/files/3mEJGI2AryCLvI7pABsv" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/bAlz6eB3TOG0n0yAGM25" alt=""><figcaption><p>Пример вызова функции автосписания</p></figcaption></figure>
...
<figure><img src="/files/69sjo8JDLzbFPpGsSu7h" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/laubUojfPQfQ3ux6br6J" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/c2jGb2WPrS43P5DLrKCA" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/payments/priem-platezhei-v-bote-cherez-yandeks.kassu.md?ask=<question>
```
