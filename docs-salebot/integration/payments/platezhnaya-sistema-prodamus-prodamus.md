> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/platezhnaya-sistema-prodamus-prodamus.md).
...
<figure><img src="/files/9w6Pb3R4ZIMwu83q1vfx" alt=""><figcaption><p>Секретный ключ в настройках формы личного кабинета платежной системы "Продамус"</p></figcaption></figure>
...
<figure><img src="/files/SgR9gmuUuy4GBvg9mNrT" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/K0AqitKqYdwQzMyVhaMN" alt=""><figcaption><p>Настройка url для уведомлений</p></figcaption></figure>
...
<figure><img src="/files/99n43sva8uLYAMV8r4XJ" alt=""><figcaption><p>Настройка url для  уведомлений для оплат по подписке</p></figcaption></figure>
...
<figure><img src="/files/O9eB0Y2ahRy3Rt2FFfdI" alt=""><figcaption><p>Раздел "Эквайринг" → Выбор платежной системы "Продамус"</p></figcaption></figure>

Далее необходимо просто указать данные, о которых говорили выше, в форму:

<figure><img src="/files/BuEaPHPNvWngshU3dhia" alt=""><figcaption><p>Форма платежной системы "Продамус" в разделе "Эквайринг"</p></figcaption></figure>
...
<figure><img src="/files/RHHKPGQVRKG9YtB7rqOc" alt="" width="563"><figcaption><p>Окно настроек кнопки</p></figcaption></figure>
...
<figure><img src="/files/lI1dYAi5daxu1KkLDMu3" alt="" width="431"><figcaption><p>Коллбэк после перехода клиентом по ссылке</p></figcaption></figure>
...
<figure><img src="/files/yan6Cwj3eMYvNSpnrTut" alt=""><figcaption><p>Страница оплаты: в кнопке заполнены только основные параметры</p></figcaption></figure>

### Дополнительные параметры формирования ссылки на оплату

<figure><img src="/files/3UvXzZy3SbneGhn9mRGd" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/Rxe9EiXkkqG4mevokYxT" alt=""><figcaption><p>Диалог в разделе "Клиенты"</p></figcaption></figure>

<figure><img src="/files/T2q1H7khQUvqbz2Z6ZpX" alt=""><figcaption><p>Настройка блока "Стартовое условие"</p></figcaption></figure>
...
<figure><img src="/files/knbc959aNntBtqAKHYny" alt=""><figcaption><p>Коллбэк об успешной оплате в поле Условие блока.</p></figcaption></figure>
...
<figure><img src="/files/q1rLe1EO1DKZfJmwZwOu" alt=""><figcaption><p>Пример коллбэка от Продамус для товаров с автоподпиской</p></figcaption></figure>
...
<figure><img src="/files/6KRkgbSxHAKUFSRGMeLn" alt="" width="524"><figcaption></figcaption></figure>

Пример реализации.

В первом блоке задаем сумму оплаты:

<figure><img src="/files/ktAYZEg2wBkBxxyaNzeM" alt=""><figcaption></figcaption></figure>

Дальше выводим в нужном месте url, ссылку prodamus\_pay\_url:

<figure><img src="/files/ljcZlIjQWjTEvbCYDzXo" alt=""><figcaption></figcaption></figure>
...
{% hint style="warning" %} <mark style="color:red;">**Важно!**</mark> Проверьте есть ли у вас на странице метод оплаты в нужной валюте, поскольку если он отсутствует, то будет переход на страницу без методов оплаты.\
Методы подключаются через поддержку. Посмотреть включенные можно в настройках страницы или сформировав ссылку на оплату
{% endhint %}

<figure><img src="/files/iTrd0JqFy7TYEbb9ArsK" alt=""><figcaption><p>Настройки страницы оплаты платежной системы "Продамус"</p></figcaption></figure>

<figure><img src="/files/kGKWCM2v4jflhoodrgYV" alt=""><figcaption><p>Варианты оплаты, которые подключены для Вашей страницы</p></figcaption></figure>
...
<figure><img src="/files/PEgPlbo8ZhmFuIJeklMh" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/SkxTDgTQfKlbF7w550IH" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/fvsaSBo7lCzgw2C08J45" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/tSLR78tdJ4BCwq8SmMDl" alt=""><figcaption><p>пример блока для уведомлений о Неуспешной оплате с конкретной причиной</p></figcaption></figure>

Для отправки сообщения **на все неудачные списания, независимо от причины**, можно настроить следующим образом:

<figure><img src="/files/HC3xyquKBRIapM1UndZD" alt=""><figcaption><p>пример блока для уведомлений о Неуспешной оплате с любым пояснением причины</p></figcaption></figure>
...
<figure><img src="/files/RwgMec0XoOfLKadlPTSs" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/WuyJs6eM8A2U9l0nYFjc" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/j19bLSnlp00E7OT0VOL5" alt=""><figcaption><p>Пример использования функции prodamus_subscription_switch_status</p></figcaption></figure>
...
<figure><img src="/files/A5xLebtdzkzSBMwbYT4g" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Q2RAstVcdYRad1Pq71cv" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/payments/platezhnaya-sistema-prodamus-prodamus.md?ask=<question>
```
