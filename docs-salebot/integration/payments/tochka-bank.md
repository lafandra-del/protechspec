> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/tochka-bank.md).
...
<div data-with-frame="true"><figure><img src="/files/5GP6UcSt6HzUcNLr5moE" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/t8C07G5Jfefe8GKJkGCi" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/MYlN2eLXmI6YlQrFjHLM" alt=""><figcaption></figcaption></figure></div>

В открывшемся окне укажите свои уникальные данные JWT токен, clientID, customerCode, merchantId в соответствующих полях:

<div data-with-frame="true"><figure><img src="/files/7teWzoms792oUYad34ub" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/zHHVjLWU53V2HxybOmwy" alt="" width="563"><figcaption></figcaption></figure></div>

Пример формирования ссылки с чеком:

<div data-with-frame="true"><figure><img src="/files/9ohXzTXj1hVLTqKYBBBj" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/P3E5cInk9PoetmqRwqpe" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/BeQY6bEcIAQoO4q6Zhkc" alt=""><figcaption></figcaption></figure></div>

2. Либо часть колбека (тогда необходимо указать выбор соответствия "По наличию ключевых слов"):

<div data-with-frame="true"><figure><img src="/files/mFvv5E9MPk1wWTpUHHqi" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/EddGf7rWfJ8rdFqwd084" alt=""><figcaption></figcaption></figure></div>

2. Весь текст колбека в условии:

<div data-with-frame="true"><figure><img src="/files/f9nNn0KMmNbjxqd0gE2A" alt=""><figcaption></figcaption></figure></div>

Либо продолжить вашу воронку и прописать текст колбека в условиях стрелки:

<div data-with-frame="true"><figure><img src="/files/hbq2mRqC02hBJhv6lIXB" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/xjcDhRixv3eDJDhgiEPf" alt="" width="563"><figcaption></figcaption></figure></div>
...
[Описание параметров указано выше в параграфе "Формирование ссылки на оплату".](#formirovanie-ssylki-na-oplatu)
{% endhint %}
...
<div data-with-frame="true"><figure><img src="/files/rrGqivs9E8qGjtnIOqC8" alt="" width="456"><figcaption></figcaption></figure></div>
...
```
GET https://docs.salebot.pro/integration/payments/tochka-bank.md?ask=<question>
```
