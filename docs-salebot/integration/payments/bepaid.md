> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/bepaid.md).
...
<figure><img src="/files/WhRivSFXZYXagEhxb5Yv" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/TaRFGd4PulFLwUQT3JNv" alt="" width="563"><figcaption></figcaption></figure>
...
В случае неудавшейся оплаты по подписке, вам придёт сообщение *<mark style="color:red;">**номерКлюча**</mark>*<mark style="color:red;">\_fail.</mark>
...
```
GET https://docs.salebot.pro/integration/payments/bepaid.md?ask=<question>
```
