> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/integration/payments/payeer.trade.md).
...
<figure><img src="/files/qURbRNf8HUhM27yPpJWk" alt=""><figcaption></figcaption></figure>

В тексте сообщения прописываем #{s}, и после запуска бота получаем список сведений о счете аккаунта.

<figure><img src="/files/Z4MzquyJHM6I8JibJEnq" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/integration/payments/payeer.trade.md?ask=<question>
```
