> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/analitika-dlya-biznesa/integracii-dlya-analitiki/eresh.md).
...
[https://vk.com/@ereshtarget-instrukciya-po-utm-metkam-v-eresh\ <br>](https://vk.com/@ereshtarget-instrukciya-po-utm-metkam-v-eresh)Если всё настроено верно, то при попадании пользователя в бота мы увидим метку, показывающую с какой именно ссылки (с какого объявления или от какого партнера) был переход.
...
\
Зарегистрироваться можно по ссылке: [https://eresh.zemedia.ru/?reg=7d22614fa7a966f98234c43c7beecda1\ <br>](https://eresh.zemedia.ru/?reg=7d22614fa7a966f98234c43c7beecda1)Заходим в раздел **внешние данные**, выбираем период за который хотим видеть статистику и нажимаем кнопку **получить данные с Salebot**.
...
3\) ID группы вк - открываем любой пост, опубликованный в группе вк, в которую вели трафик и копируем только номер из адресной строки <https://vk.com/topispolniteli?w=wall-198248940_35>
...
```
GET https://docs.salebot.pro/analitika-dlya-biznesa/integracii-dlya-analitiki/eresh.md?ask=<question>
```
