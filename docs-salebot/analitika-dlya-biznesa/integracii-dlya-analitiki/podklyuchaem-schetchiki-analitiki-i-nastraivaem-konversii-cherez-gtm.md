...
Скачиваем готовый контейнер: <https://yadi.sk/d/0nFKXE4m71_D7w>&#x20;
...
| Топ маил ру      | <p>var \_tmr = window.\_tmr                                           |                                                                                                                               | (window.\_tmr = \[]);</p><p>  \_tmr.push({ id: "{{TOP\_Mail.ru}}", type: "reachGoal", goal: "subscribe" });<br></p> | Создать цели на событие subscribe |
...
```
GET https://docs.salebot.pro/analitika-dlya-biznesa/integracii-dlya-analitiki/podklyuchaem-schetchiki-analitiki-i-nastraivaem-konversii-cherez-gtm.md?ask=<question>
```
