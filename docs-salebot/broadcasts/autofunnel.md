> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/broadcasts/autofunnel.md).
...
<figure><img src="/files/j267I1Nuc7lB7Kk9PJTo" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/SDpJeANWJyrKY7q13Yuf" alt="" width="563"><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/broadcasts/autofunnel.md?ask=<question>
```
