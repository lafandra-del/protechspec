> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/chasto-zadavaemye-voprosy/kak-pereekhat-v-salebot/kak-pereekhat-s-bothelp.md).

# Как переехать с BotHelp

## **Как переехать с Bothelp на Salebot?**

1. [Подключаем мессенджеры к Salebot.](/chatbots/channels.md)
...
{% hint style="success" %}
Как подключить любой представленный на платформе Salebot мессенджер, рассказали в разделе "[Подключение мессенджеров и каналов](/chatbots/channels.md)"
{% endhint %}

Далее увидим кнопку для загрузки списка клиентов:

<div data-with-frame="true"><figure><img src="/files/M4nxoUgVuqfi6XZM59ru" alt=""><figcaption></figcaption></figure></div>

После нажатия на кнопку, открывается окошко загрузки файла, где выбираем кодировку и разделитель:

<div data-with-frame="true"><figure><img src="/files/ooTio9fsGyby0Ib3AMug" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/wY4YD8QvsrJMAwGOtbeh" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/rs21JU47kVYjyhTYVd2Y" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div><figure><img src="/files/G4Nlu9Cf1pKQCfZQLe8N" alt="" width="419"><figcaption><p>1) Добавляем функцию кнопки в блоке</p></figcaption></figure> <figure><img src="/files/IuNW5zSHdtFpFgaLle3C" alt="" width="406"><figcaption><p>2) Добавляем саму кнопку</p></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/JY3IpyysbHE5YKfQGKOY" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/En35wtiCUXVmEetg9mLf" alt=""><figcaption></figcaption></figure></div>
...
<div><figure><img src="/files/AjDisXPRZw57LADMgfq6" alt="" width="374"><figcaption></figcaption></figure> <figure><img src="/files/oArB1FXKX20Pd69XdmSF" alt="" width="368"><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/fZrbTJyHtqicMQoE7vLw" alt="" width="362"><figcaption></figcaption></figure></div>

Тестируем бота:

<div><figure><img src="/files/479MljYxDI8CpAAXqblw" alt=""><figcaption><p>Настройки вложения</p></figcaption></figure> <figure><img src="/files/kR7kZqDloGURlvDEU9Mz" alt=""><figcaption><p>Тест бота</p></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/FKmdFtnkS0YQrW3S7DD3" alt="" width="563"><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/0cTosVF5cvPLJYRHRobb" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/ccRjVmDFmyUxyxYgS0KK" alt=""><figcaption></figcaption></figure></div>
...
Для этого воспользуйтесь переменной *#{next\_day}*, вставьте ее в поле назначения даты.

<div data-with-frame="true"><figure><img src="/files/WdDRuwWL85sFYdeR5KaI" alt=""><figcaption></figcaption></figure></div>
...
Слева в разделе “*списки*” необходимо создать список (или метку). Затем в нужном блоке, в расширенных настройках выбрать “действие со списком” (например “добавить” будет означать добавить в список или присвоить метку) и в поле ниже выбрать название ранее созданного списка.&#x20;

<div data-with-frame="true"><figure><img src="/files/tzMXybqBGGEhR2ZtSWPi" alt=""><figcaption></figcaption></figure></div>
...
<div><img src="https://lh5.googleusercontent.com/VzC7rOFm4rjznpry92IB09L7UKEHOksZjl9epRKgqWNFLMrOwxXSfzgyungVcX7kRfUe021vX5OFLEB-JhlCYwdO4Mxq3P46Limu6xtqHpMYZQ6JCvd4JOckeoZ3k21ppWLJtK1P" alt=""> <figure><img src="/files/SMPTWr2SSnnKHmZs8PBs" alt=""><figcaption></figcaption></figure></div>

Установить значение полю (а также очистить его) можно через переменную в калькуляторе в блоке схемы:

<div><figure><img src="/files/har3jk9eJQfJtfZtOyxb" alt="" width="392"><figcaption><p>Значение для поля</p></figcaption></figure> <figure><img src="/files/8s60Fbq8CENwFyJnQVPG" alt="" width="397"><figcaption><p>Очистить поле</p></figcaption></figure></div>

### **Действия "Увеличить на" и  "Уменьшить на"**

<div><img src="https://lh6.googleusercontent.com/KrkcG5yPGqvrrDqNeMId5pCw7ON3_mi2d1r0qbUFXAKsnZ5ly37PcUj43_Bv8XuR4ZqtemkfE95lANtWq4BdEzRwkw1Lw-enyJDIH29FPTqJMAREc8sDT-l6Z7GXZHh_WIRqLoVq" alt="BotHelper"> <figure><img src="/files/MiutbRbE6zupzNwWCdOL" alt=""><figcaption><p>BotHelper</p></figcaption></figure></div>

Данные действия также можно осуществить в блоке схемы с помощью поля калькулятора. Для этого присвойте значение +1 или -1:

<div><figure><img src="/files/HPdPR1d7DmuVJuRZdEO0" alt="" width="407"><figcaption></figcaption></figure> <figure><img src="/files/2xDNMl37cDD5lniUOj9Y" alt=""><figcaption></figcaption></figure></div>
...
В текст блока ожидания ставьте переменную *#{none}* , тогда пользователю ничего не будет отправлено, но он перейдет в нужный нам блок и будет находиться в назначенные в стрелке 3 даты и времени рассылки.

<div data-with-frame="true"><figure><img src="/files/QvwYTmRqvYYHQv8yx1WT" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/nEIAE8ukjDNACRP9ABg6" alt=""><figcaption></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="/files/kbNqeoNdxLmDdWQyWUkO" alt=""><figcaption></figcaption></figure></div>
...
```
GET https://docs.salebot.pro/chasto-zadavaemye-voprosy/kak-pereekhat-v-salebot/kak-pereekhat-s-bothelp.md?ask=<question>
```
