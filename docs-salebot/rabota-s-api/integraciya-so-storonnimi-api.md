> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/rabota-s-api/integraciya-so-storonnimi-api.md).
...
```
GET https://docs.salebot.pro/rabota-s-api/integraciya-so-storonnimi-api.md?ask=<question>
```
