> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/online_courses/builder/courses.md).
...
<figure><img src="/files/M7dufnwmHQySBMGJvjJy" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Ir7yXC8wMY3w4m4k4h21" alt=""><figcaption></figcaption></figure>

После клика по кнопке "Создать курс" вы перейдете в основные настройки курса:

<figure><img src="/files/t6IlHySI1H0OR95r59DI" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/rZ5FpKSn81fSFz0UeiHi" alt=""><figcaption></figcaption></figure>

Меню настроек откроется справа на экране:

<figure><img src="/files/7tlEYStwpCl0FTcL70cj" alt=""><figcaption></figcaption></figure>

### Общие

<figure><img src="/files/CVH7XjDPEIoFPEJnrcX5" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/MEw2PgLB3XoFWSwNe4uA" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/cEX1pRmuPXMXz68h3GYS" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/oJgLihMXeIBD8zKT3ETt" alt="" width="563"><figcaption></figcaption></figure>

Тогда откроется модальное окно, в котором необходимо будет ввести настроенный вами домен:

<figure><img src="/files/Nng6BvdbqDGmWJjxZNVy" alt=""><figcaption></figcaption></figure>

{% hint style="info" %}
Как создать запись А, читайте в этой [статье](https://docs.salebot.pro/online_courses/builder/pages/SVmo5FWy8HXy0n1EdOSO#10.-ustanovlenie-domena).
{% endhint %}
...
<figure><img src="/files/ZN9xl6QNtsUqiH0Hb51C" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/X4dOrSA2z2YPOhosXuDt" alt=""><figcaption></figcaption></figure>

#### Отправлять колбеки

<figure><img src="/files/YLwEwzV45zReUkZ8T3xR" alt="" width="563"><figcaption></figcaption></figure>
...
*<mark style="color:green;">**Новые домашние задания**</mark>* \
\&#xNAN;**`course_homework_send_new course_id: 111, lesson_id: 222`** \
111 - id  вашего курса будет. \
222 - id урока \
\&#xNAN;*<mark style="color:green;">**Повторные домашние задания:**</mark>*\
...
<figure><img src="/files/Mbb81MJ9r9RxB3OEY70F" alt=""><figcaption><p>Условие и тип соответствия указывают или в блоке или в стрелке. </p></figcaption></figure>

*<mark style="color:green;">**Открытие урока:**</mark>* \
...
*<mark style="color:green;">**При окончании курса:**</mark>* \
...
<figure><img src="/files/BZg7zWNCYm9hEiNVWORH" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/0VsmS34IG9s9gUTNgngp" alt="" width="563"><figcaption></figcaption></figure>

Превью курса будет также отображаться, например, на сайте при добавлении секции карточки курса:

<figure><img src="/files/OKliT7Lf1ZdTgdY4AWmW" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/iEydvd526xHOpoZxZE89" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="/files/jC8qhZELh8ki69MOFtSO" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/eg5LvEcL59TugkUr8TqT" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/oSckUFtxvFFkBcerQtju" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/gzPO9Sd3jRaaQ7RMPm0p" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/8DOwxwnI7n6PKIDEnPVv" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/Rb9H82AtNEDq4F5uAVvW" alt="" width="563"><figcaption></figcaption></figure>

По умолчанию установлено овальное скругление, но также доступно округлое и квадратное (без скругления):

<figure><img src="/files/Zp30LtO5GmmCD65GbUEr" alt=""><figcaption><p>Без скругления элементов</p></figcaption></figure>

<figure><img src="/files/3SWDIK6cXk8myUkAzIZW" alt=""><figcaption><p>Округлое скругление элементов промо страницы</p></figcaption></figure>

#### Настроить свою тему

Если предустановленные темы не подошли под ваше дизайнерское решение, то активируйте чекбокс "Настроить свою тему":

<figure><img src="/files/vUUw4YOsYZc98nQAFVY1" alt="" width="563"><figcaption></figcaption></figure>

Расширенные настройки темы помогут настроить собственную кастомизацию курса:&#x20;

<figure><img src="/files/FSRDYG2qAZ2uxaWr4eEM" alt="" width="375"><figcaption></figcaption></figure>

К заднему фону промо-страницы можно применить различные интересные узоры.&#x20;

#### Горизонтальная ориентация уроков/тарифов

<figure><img src="/files/8XrXGFdn59C5bkai22aN" alt="" width="375"><figcaption></figcaption></figure>

Для отображения уроков и тарифов на промо странице курса в горизонтальном или вертикальном виде:

<figure><img src="/files/e8lYI46QyB2umlXSVAth" alt="" width="563"><figcaption></figcaption></figure>

### Шапка страницы

По умолчанию, логотип в шапке отображается как основное лого Salebot.

<figure><img src="/files/4GWbyjpeCTbe1HKMUXUl" alt=""><figcaption></figcaption></figure>

Если вам необходимо отображать иное название или изображение, воспользуйтесь настройками здесь:

<figure><img src="/files/bKJzEmW2TOaPf8rHK8sS" alt="" width="375"><figcaption></figcaption></figure>

Можно загрузить изображение, ввести в поле URL ссылку на изображение, а также прописать логотип текстом.

<figure><img src="/files/jf8QDLzEVr1AEHOGaage" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/K72hm1OG6U2Y6w143zHJ" alt=""><figcaption></figcaption></figure>

Настройки обложки курса начинается с двух текстовых редакторов, в которых прописывается название курса и его описание:

<figure><img src="/files/7aJbjhMmH5vOxDnEHWho" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="/files/rEu34zdX4rCNHFMWf7z2" alt=""><figcaption></figcaption></figure>

Чтобы добавить дополнительные теги над заголовком курса, воспользуйтесь кнопкой "Добавить тег":

<figure><img src="/files/X0prvMRW3QtmnOjIj82C" alt=""><figcaption></figcaption></figure>

**Выравнивание обложки**

<figure><img src="/files/WU1XtBdEjclcNabYjfdS" alt="" width="513"><figcaption></figcaption></figure>

По умолчанию контент обложки расположен по середине:

<figure><img src="/files/l8goxLqrfIbiE6ZU6iF1" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/oN85lo8dNaG7fFHMH4CI" alt=""><figcaption></figcaption></figure>

Тогда откроются настройки для загрузки медиа в правую часть обложки:

<figure><img src="/files/EOyk0eJrKAg7RgK0wKpm" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/fGpfNxjQsTIqBBWiHKml" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/Pf4hF22lnKaqsCPBTX2g" alt=""><figcaption></figcaption></figure>

### О курсе и авторе

<figure><img src="/files/NLpRwzLUQfj8wUsYQuYk" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="/files/hnldCz2CSI7ZtJljJdbT" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/2V81KMRsch6afjjcPiCg" alt="" width="375"><figcaption></figcaption></figure>

Настройка ссылки в футере поможет добавить на промо курса необходимые и важные ссылки в нижнюю часть страницы:&#x20;

<figure><img src="/files/3GfQP8yTYv65MyS5wLdp" alt=""><figcaption></figcaption></figure>

Для этого в настройках кликните на "Добавить ссылку":

<figure><img src="/files/m8YzjTRKFfobGcGGgeVZ" alt="" width="563"><figcaption></figcaption></figure>

Далее введите название для пункта меню, например, "публичная оферта", а также укажите URL, куда будет вести ссылка:

<figure><img src="/files/nRw6BvfgdRTAtv49bFok" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/8CMaS08vJgkJaWsG95i6" alt="" width="563"><figcaption></figcaption></figure>

#### Реквизиты

Также для промо-страницы существует возможность добавить реквизиты: организации, ИП и пр.:

<figure><img src="/files/leFtWNdpjsqn88o5GHN2" alt="" width="563"><figcaption></figcaption></figure>

Реквизиты также отображаются в нижней части страницы промо курса, как и футер с пунктами меню:

<figure><img src="/files/9Sp1KXNmdEsjJASmZDrW" alt=""><figcaption></figcaption></figure>

Вам достаточно заполнить пустые текстовые поля в плашке "Реквизиты":

<figure><img src="/files/SZPJEzRvvHRXsEZ9GaWT" alt="" width="563"><figcaption></figcaption></figure>

### Аналитика

<figure><img src="/files/ug1mjf32K8culHdNZVuu" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="/files/QdAiCMN3D2xmLXgB0bfi" alt="" width="375"><figcaption></figcaption></figure>

Для этого необходимо активировать чекбокс "Отображать кнопку стать партнером":

<figure><img src="/files/Y477f6k6po1YQS231oMn" alt="" width="563"><figcaption></figcaption></figure>

Тогда кнопка "Стать партнером" будет отображена на промо-странице курса:

<figure><img src="/files/mSyfWnDTkfjF2R5j0tB3" alt=""><figcaption></figcaption></figure>

При клике на кнопку, вашему будущему партнеру будет открыта форма для заполнения собственных данных:

<figure><img src="/files/lg3Yoq2maVS1aKkhwILB" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/EPWZ8PRI5PbfmfIdb5zI" alt="" width="375"><figcaption></figcaption></figure>

Тогда в форме будет отображен чекбокс с ссылкой на страницу с условиями партнерской программы:

<figure><img src="/files/oEmNdwBMrskplwvEB5dU" alt="" width="375"><figcaption></figcaption></figure>

Все партнеры вашей школы будут отображены во вкладке "Партнерская программа" в разделе "Курсы":

<figure><img src="/files/2hytquEUqa2CvdwcJPlt" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Njst2BBtsfEjtT0TZrvi" alt=""><figcaption></figcaption></figure>

Далее в выпадающем списке выберите тип комиссии: "Процент с продажи" или "Фиксированная сумма":

<figure><img src="/files/GXIzLsUAuvizpFETyMZl" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/ttsJ5gBT1nWyewhUyBBx" alt=""><figcaption></figcaption></figure>

2\) если фиксированная сумма, то укажите необходимую сумму без символов, пробелов:

<figure><img src="/files/eZeqdcaxK4KAvPdttcaV" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/cMCNIVz5iu1cV4hUZfxa" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/online_courses/builder/courses.md?ask=<question>
```
