> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/online_courses/builder/lessons.md).

# Уроки и модули

Чтобы создать первый урок в курсе, необходимо переместиться во вкладку **Уроки** и нажать на кнопку **Создать:**

<figure><img src="/files/9ZRSDwPUcJ5GRbXJPJzh" alt=""><figcaption></figcaption></figure>

Далее открывается пустая страница для добавления секций контента урока:

<figure><img src="/files/jP4xHM9h4HVhgEM15ScT" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Pr5vou2VsAfl8hpF61by" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/tbSzu9SoEPnLBQpXkjn4" alt="" width="375"><figcaption></figcaption></figure>

Для уроков существуют следующие виды блоков (секций):

<figure><img src="/files/bpgXTEneALtWGTjI9tNy" alt=""><figcaption></figcaption></figure>

Чтобы добавить текст в контент урока, необходимо кликнуть на секцию "Заголовок и текст":

<figure><img src="/files/UJfmCQ3wNekSTExaHvpj" alt=""><figcaption></figcaption></figure>

Тогда секция с текстом добавится в контент вашего урока:

<figure><img src="/files/yUlDerf9pjFCFhJXzVnP" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/dLDiTmdqab3nvW2WDZj2" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/SrrBH8tOHAy8kK96nPS0" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="/files/NX0T3G98h0Zpjzb0dcse" alt="" width="368"><figcaption></figcaption></figure> <figure><img src="/files/HgGMJ4smzSg3UihToUJs" alt="" width="563"><figcaption></figcaption></figure></div>
...
<figure><img src="/files/CqZCe8q05cA5YFNACOWP" alt=""><figcaption></figcaption></figure>

Далее в секции нажмите на кнопку "Загрузить из хранилища", которая расположена под полем для URL:

<figure><img src="/files/memdBLyfJ0V8WljHttJC" alt="" width="375"><figcaption></figcaption></figure>

И в открывшемся окне выберите вложение для загрузки:

<figure><img src="/files/9lO38MohFRxwrJtAOPVx" alt=""><figcaption></figcaption></figure>

Тогда медиа подгрузится в секцию урока:

<figure><img src="/files/9dpQPHP0Lk8ewmPEmcch" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/clWSslFkKBpQkDPfCiPA" alt="" width="563"><figcaption><p>Кликните на кнопку для отображения переменных</p></figcaption></figure>

<figure><img src="/files/wK03iko5d6mBIs8dtlZu" alt=""><figcaption><p>Переменная для установки таймкода в видео находится в блоке Стандартные переменные</p></figcaption></figure>
...
{% hint style="success" %}
Подробнее о настройках вебинаров и трансляций рассказали в статье "[Трансляции](/online_courses/webinars/builder.md)".&#x20;
{% endhint %}
...
<figure><img src="/files/eWxot53nI3ujkexxQ1Eh" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/SDw8JmiCd1wd1K9y6kis" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/iOI5DmlwyjshZ3hBoOk9" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/IoL1mELxbk5f4kMbrcRe" alt=""><figcaption></figcaption></figure>

Найдите поле, которое называется ID секции:

<figure><img src="/files/YQ0y04cI0ymOnKA522F2" alt="" width="375"><figcaption></figcaption></figure>

И пропишите удобное название ID секции по установленным ограничениям для названия id секции:

<figure><img src="/files/I3FftCsIhun44q7wT733" alt=""><figcaption></figcaption></figure>

Например, название нашей секции будет иметь следующий вид:

<figure><img src="/files/02JufHYFFrb1vNcfHuPf" alt="" width="563"><figcaption></figcaption></figure>

Теперь скопируйте название и сохраните настройки:

<figure><img src="/files/9FSL1Obqkyf0Vo5D7HBK" alt="" width="563"><figcaption></figcaption></figure>

Далее создайте секцию с кнопками (можно сделать секцию "Меню" либо секцию "Кнопки"):

<figure><img src="/files/2LZBxUD3J2Sv0j2u1chp" alt=""><figcaption></figcaption></figure>

При клике на необходимую секцию, сразу откроется меню для настроек контента секции (в примере добавлена секция "Кнопки"):

<figure><img src="/files/VEodwNGV0Lbldvw0hDQN" alt=""><figcaption></figcaption></figure>

Нажмите на кнопку "Оплата" (данная кнопка является кнопкой по умолчанию без функции оплата), чтобы изменить ее настройки:

<figure><img src="/files/h6avhVRlZW785uDk0fnK" alt="" width="375"><figcaption></figcaption></figure>

В открывшемся модальном окне измените название кнопки:

<figure><img src="/files/7oACvztbYThVVPGN2QjV" alt=""><figcaption></figcaption></figure>

Функция остается та же "Ссылка", а вместо значения #url передайте название ID секции:

<figure><img src="/files/iu7sdzBMoplFkGoADHdC" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/axdOShhIuh8ldiIbsQwp" alt="" width="563"><figcaption></figcaption></figure>

Переход к секции по ее ID должен быть в этом же окне:

<figure><img src="/files/948PTSrAr3M86Z7MmJ0T" alt="" width="563"><figcaption></figcaption></figure>

Далее можно установить кастомные настройки кнопки: цвет, ширина и т.п.:

<figure><img src="/files/VGvrxfb9IF1vCoo2caJ7" alt="" width="563"><figcaption></figcaption></figure>

Далее нажмите сохранить:

<figure><img src="/files/nCT2cLLEVaN9jO51dtPd" alt="" width="563"><figcaption></figcaption></figure>

Чтобы удалить вторую кнопку, если она не нужна, или так же, как описано выше, настроить ее, кликните по кнопке:

<figure><img src="/files/pXd9MHTbUjtLgrHZ2qz9" alt="" width="563"><figcaption></figcaption></figure>

И проделайте необходимые настройки либо удалите кнопку:

<figure><img src="/files/bGKMVP8SO1XRbsx08Wwp" alt="" width="563"><figcaption></figcaption></figure>
...
{% hint style="info" %}
Подробнее о дожимах в онлайн-курсах рассказали в статье "[Уведомления и дожим](/online_courses/builder/notification.md)"
{% endhint %}

Чтобы перейти в основные настройки страницы урока, нажимаем **Настройки** в верхнем меню:

<figure><img src="/files/cUhaiPntGpq7eC8AjwyP" alt=""><figcaption></figcaption></figure>

Откроется меню с разделами настроек:

<figure><img src="/files/dSP0Gtm0L0oXlJsqQGR9" alt=""><figcaption></figcaption></figure>

### Основная информация

<figure><img src="/files/8PHKzuXvq4IiqziLQ9xJ" alt="" width="563"><figcaption></figcaption></figure>

#### Информация о странице

<figure><img src="/files/e1GFdKfDpelfTDHsRINh" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/DIfHn1CQ7ZoA1WUW47t1" alt=""><figcaption></figcaption></figure>

А название урока на промо странице курса, а также на странице ученика:

<figure><img src="/files/pyeCJMRfomkNLuOZrFP0" alt="" width="563"><figcaption><p>Заполненные поля в настройках</p></figcaption></figure>

<figure><img src="/files/v0AvFb1jP3MVKMbeNeW4" alt="" width="563"><figcaption><p>Названия уроков на странице курса</p></figcaption></figure>

#### Настройка изображений

<figure><img src="/files/DOWXLBLbNgSkogIJfuOW" alt="" width="563"><figcaption></figcaption></figure>

Чтобы указать уникальный логотип страницы вместо иконки Сейлбота, вы можете загрузить собственное изображение:

<figure><img src="/files/z2uay7MKpt4DCqJ3fCpd" alt=""><figcaption><p>Загруженный фавикон</p></figcaption></figure>

<figure><img src="/files/2PfVYjTh794h6fRgAOeR" alt="" width="563"><figcaption><p>Где отображается фавикон</p></figcaption></figure>
...
<figure><img src="/files/bRtWMBzQ2lm8iSftvfYw" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/Uuw9EyFIhPbwJUTel0Tb" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/65MOdcKPBWMuLIk0MUI6" alt=""><figcaption></figcaption></figure>

#### Настройка интерфейса и доступа

<figure><img src="/files/8g6XK9fFPYSz0ttgPXeF" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/3r5K3rBm5sfN82p9HOiy" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/RRaYPrYRXR6Ai3ocZG61" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/zElMxSCLIkbNmn0YYHhU" alt="" width="563"><figcaption></figcaption></figure>

Здесь существует возможность выбрать формат домашнего задания:  в виде теста или стандартное:

<figure><img src="/files/kG8BAJ4BP77zbsnd7ak2" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/T2EmyaJ41qC8t3VBRsoE" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/82Ni3HdL1pSVHRzOpYPt" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/M4teHt2ZD2bcl9snTKgB" alt="" width="563"><figcaption></figcaption></figure>

Нажмите на "Создать вопрос", затем в поле вопроса введите необходимый текст:

<figure><img src="/files/WUSK21PuvoXjU5MJMRMz" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/vUfzjlIHouRF5Yi9ytAB" alt=""><figcaption></figcaption></figure>

Чтобы добавить еще один вопрос, нажмите на соответствующую кнопку:

<figure><img src="/files/0nZ1l72C5RwdogHkYYqS" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/WXRJ88goJc4HeW4ilnja" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/ltjBcphgsepSdAkBHhVA" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/4z7AsTUtqXstsDDXOEU6" alt="" width="450"><figcaption><p>Красная плашка с цифрой обозначает<br>количество сданных и не проверенных<br>кураторами д/з</p></figcaption></figure>

Далее куратору необходимо перейти в раздел с новыми сданными д/з:

<figure><img src="/files/64vikZkEaCZJRFmf5wcI" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/gkDSeKIH9E5EXTgQZ6qQ" alt="" width="563"><figcaption></figcaption></figure>

У ученика, который проходит курс, уроки с домашними заданиями отображаются следующим образом:

<figure><img src="/files/6zljsjTUSrz7PTZHlEiP" alt=""><figcaption></figcaption></figure>

Далее достаточно кликнуть на ученика, после чего откроется подробная информация по каким курсам было сдано д/з:

<figure><img src="/files/ylMKfNQ0N5u8FpptvrY3" alt=""><figcaption></figcaption></figure>

Чтобы открыть д/з, куратору достаточно кликнуть на соотвествующую кнопку и увидеть содержимое сданного д/з:

<figure><img src="/files/zdsDVe4NkdFSNqtp0Fka" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/elCDOwFSQRKeFVyBUz7G" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/KUAZyFMh0jkRPUjwjgQb" alt="" width="563"><figcaption></figcaption></figure>

И выбрать необходимый шаблон и кликнуть по кнопке "Создаить урок":

<figure><img src="/files/sMqkBEoEOBIdHnUOAxeO" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/TRHCjTvICGNALFxKXPKO" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/IseQN1TjkDmWQ8zQcFRf" alt="" width="563"><figcaption></figcaption></figure>
...
<img src="/files/FDSUEkWGBZ2tsZA91vVo" alt="" data-size="original">
{% endhint %}
...
<figure><img src="/files/fJCcuYNujtLMG0yJzW73" alt="" width="333"><figcaption></figcaption></figure>
...
<figure><img src="/files/PFShktH3Yp3DTQ4TP0tq" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="/files/t3iA5pILsMYEcEHR2z1r" alt="" width="563"><figcaption><p>Отображение уроков на промо странице курса</p></figcaption></figure>

<figure><img src="/files/ZQfDSQiND3xrgo5TRhrz" alt=""><figcaption><p>Порядок отображения уроков в настройках курса</p></figcaption></figure>

Чтобы поменять местами уроки, нужно зажать кнопку в правом углу плашки:

<figure><img src="/files/CLAyVmXThw2TlcGYaRxb" alt="" width="563"><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/online_courses/builder/lessons.md?ask=<question>
```
