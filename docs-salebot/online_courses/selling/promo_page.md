> For the complete documentation index, see [llms.txt](https://docs.salebot.pro/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.salebot.pro/online_courses/selling/promo_page.md).

# Продажа курсов на промо-странице

Интеграция платежных сервисов с Salebot позволяет проводить продажи ваших курсов прямо на ***промо-странице***\*, что существенно упрощает процесс оплат и записи на курс для пользователей (клиентов).&#x20;
...
Промо-страница курса настраивается в разделе "[Общие настройки](/online_courses/builder/courses.md#obshie)"

Промо-страница выглядит так:

<img src="/files/oSckUFtxvFFkBcerQtju" alt="" data-size="original">
{% endhint %}
...
<figure><img src="/files/Ouq08e5XAwQhGpwKDyo0" alt="" width="375"><figcaption></figcaption></figure>

Далее подключите любую платежную систему, например, в которой у вас уже есть настроенный магазин:

<figure><img src="/files/AMb6X73oLAS3lYDaovng" alt=""><figcaption></figcaption></figure>

Каждая платежная система имеет свои особенности подключения, описание и подробная инструкция которых существует [в документации Salebot. ](/integration/payments.md)
...
<figure><img src="/files/gtn9i76THjDMRRTyVc7g" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/yT4ctfj2azPjyp2kDpAZ" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/T5BVU5CC240mHqXPQIXW" alt="" width="563"><figcaption></figcaption></figure>

<figure><img src="/files/hQ7TvxHQ0n60jN6mUGHI" alt="" width="563"><figcaption></figcaption></figure>

Далее выберите необходимый платежный сервис и сохраните настройки:

<figure><img src="/files/7hCleOoGdAhAvJBt3hTZ" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/yBq0ywiO6goJnrSXrrdy" alt="" width="563"><figcaption></figcaption></figure>
...
Как настроить тариф в онлайн-курсах, читайте в[ одноименной статье.](/online_courses/builder/plans.md)
{% endhint %}

Чтобы ученику вашего курса купить любой тариф, ему достаточно перейти на страницу курса:

<figure><img src="/files/tUGBgWuthAfQRVY4bXsq" alt=""><figcaption><p>Светлая тема (можно выбрать в настройках курса)</p></figcaption></figure>
...
<figure><img src="/files/0FXM6FPqWfyfM5IiTTSi" alt=""><figcaption><p>Темная тема (можно выбрать в настройках курса)</p></figcaption></figure>

Далее клиент автоматически перейдет на страницу с формой оформления заказа, где ему необходимо будет указать свои данные:

<figure><img src="/files/WOoAhbDCuHCYl2KcYd8H" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/43uvaXJid7dnt3BavSK9" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/0hZkhyHVegJlHNxjwuAU" alt="" width="563"><figcaption></figcaption></figure>

После того как пользователь убедится в правильности вводимых данных, ему останется оплатить свой заказ:

<figure><img src="/files/L6LtTrzMOOgRmIeoCZtm" alt=""><figcaption></figcaption></figure>
...
```
GET https://docs.salebot.pro/online_courses/selling/promo_page.md?ask=<question>
```
